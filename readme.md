...
2. one of commands below depending of your preference (run as *root* or use *sudo*)
    - `./ams --full --node=SMARTCASH_SMART` # full setup of SMARTCASH Smartnode for current user
    - `./ams --full --user=[user] --node=SMARTCASH_SMART --auto-update-level=[level] -sp=ip=[external ip] -sp=masternodeprivkey=[MN privkey]` 
